...
abstract class AbstractFileSource extends AbstractSource
{
    ...
    * @param \Niirrty\Locale\Locale           $locale      The locale of the required translations
    * @param \Psr\Log\LoggerInterface|null    $logger      An optional logger.
    * @param \Niirrty\IO\Vfs\IVfsManager|null $vfsManager  Optional Virtual File System Manager if $transFolder requires
    */
    ...
    *
    * @return \Niirrty\IO\Vfs\IVfsManager|null
    */
    ...
    *
    * @param  \Niirrty\IO\Vfs\IVfsManager|null $manager
